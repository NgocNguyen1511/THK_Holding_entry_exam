    ...
    <div class="search-hotel-name">
        <form action="{{ route('adminBookingSearchResult') }}" method="get" class="booking-search-form">
            ...
            <div class="form-group">
                ...
                <input type="datetime-local" id="checkin_time" name="checkin_time" value="{{ request('checkin_time') }}">
            </div>
            <div class="form-group">
                <label for="checkout_time">チェックアウト日時</label>
                <input type="datetime-local" id="checkout_time" name="checkout_time" value="{{ request('checkout_time') }}">
            </div>
